...
def render_mesh(args):
    # default settings
    gpus = str(args.gpu) + ","

    if args.baseline == True :
        input_path = os.path.join(args.output_dir, "sync_output_baseline.png")
        output_path = os.path.join(args.output_dir, "mesh")
        output_path_mesh = os.path.join(args.output_dir, "mesh.ply")
    else :
        input_path = os.path.join(args.output_dir, f"sync_output{args.index}.png")
        output_path = output_path = os.path.join(args.output_dir, f"mesh{args.index}")
        output_path_mesh = os.path.join(args.output_dir, f"mesh{args.index}.ply")
