...
def main(args):    
    ...
    mask0_path = os.path.join(args.output_dir, "mask0.jpg")
    mask1_path = os.path.join(args.output_dir, "mask1.jpg")
    mesh0_path = os.path.join(args.output_dir, "mesh0.ply")
    mesh1_path = os.path.join(args.output_dir, "mesh1.ply")
    depth_to_points_path = os.path.join(args.output_dir, "depth_to_points.npy")
    ...
    # Exporting
    print("\t>>> Exporting ...")
    o3d.io.write_triangle_mesh(os.path.join(args.output_dir, "result_mesh0.ply"), result_mesh0)
    o3d.io.write_triangle_mesh(os.path.join(args.output_dir, "result_mesh1.ply"), result_mesh1)
    o3d.io.write_triangle_mesh(os.path.join(args.output_dir, "result_merged_mesh.ply"), merged_mesh)
